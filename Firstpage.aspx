<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Firstpage.aspx.cs" Inherits="asp.net1.Firstpage" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
--%>
        ...
        <br />
        <asp:Button ID="btn1" runat="server" Text="submit" OnlClick="btn1_Click" />
    </form>
</body>
</html>
