...
namespace ConsoleApp1.ProductManagement
{
    ...
    //{
    //    #region haa
    //    const string GETALL = "sp_GetAllProduct";
    //    const string GETDETAILS = "sp_GetProductDetais";
    //    const string INSERT = "sp-CreateProduct";
    //    const string UPDATE = "sp_UpdateProducts";
    //    SqlConnection connection;
    //    string connectionstring = @"Data Source=(local)\sqldev2016;initial catalog=northwind;integrated security=sspi";
    //    private void CreateConnection()
    //    {
    ...
    //        //if (string.IsNullOrEmpty(criteria))
    //        //{
    //        //    throw new ArgumentException(nameof(criteria), "required argument missing");
    //        //}
    //        List<Product> productList = new List<Product>();
    //        CreateConnection();
    ...
    //    }
    //    public Product GetProduct(Product item) { return null; }
    //    public void CreateProduct(Product item)
    //    {
    //        if (item == null)
    //            throw new ArgumentNullException(nameof(item), "required argument missing");
